...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-12 w-full items-center justify-between gap-2 rounded-md border-2 border-input bg-card px-3 py-2 text-base text-foreground transition-[transform,box-shadow] duration-[var(--dur-fast)] ease-pop sm:text-sm",
