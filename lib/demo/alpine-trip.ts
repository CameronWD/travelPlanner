...
const TRANSPORTS: DemoTransport[] = [
  ...
  },
  {
    ...
    arrLat: 45.9937,
    arrLng: 9.2564,
    notes: "~2h via A2/San Gottardo or scenic Maloja pass.",
    sortOrder: 4,
    cost: { estimatedMinor: 3000, currency: "EUR" },
  },
  {
    key: "alp:tr:pilatus",
    mode: "OTHER",
    ...
    arrLat: 46.9789,
    arrLng: 8.2525,
    depPlace: "Kriens gondola station",
    arrPlace: "Pilatus Kulm (2132 m)",
    notes: "Aerial gondola up, cog-railway down — the world's steepest rack railway.",
    sortOrder: 5,
    cost: { estimatedMinor: 7200, currency: "CHF" },
  },
];
