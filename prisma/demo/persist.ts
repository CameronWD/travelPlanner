      ...
      if (t.cost) {
        await db.cost.create({
          data: {
            ...
            ownerType: "TRANSPORT",
            ownerId: dbT.id,
            costMinor: t.cost.costMinor,
            paidMinor: t.cost.paidMinor ?? null,
      ...
      if (a.cost) {
        await db.cost.create({
          data: {
            ...
            ownerId: dbA.id,
            costMinor: a.cost.costMinor,
            paidMinor: a.cost.paidMinor ?? null,
      ...
      if (it.cost) {
        await db.cost.create({
          data: {
            ...
            ownerType: "ITEM",
            ownerId: dbItem.id,
            costMinor: it.cost.costMinor,
            paidMinor: it.cost.paidMinor ?? null,
