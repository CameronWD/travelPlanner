 ...
 *
 * Catches unexpected errors thrown in any (app) route that doesn't have a
 * more specific error.tsx of its own, so the Traveller sees a friendly
 * recovery UI instead of the framework's default error screen. The raw error
 * is logged but never rendered, so internal details / stack traces are not
 * leaked.
 */
